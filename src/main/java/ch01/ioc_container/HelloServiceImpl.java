...
public class HelloServiceImpl implements HelloService, BeanNameAware,
	...
	public void setMyTime(MyTime myTime) {
		this.myTime = myTime;
		System.out.println("2. 의존성 체크 후 property로  빈 인스턴스 주입: myTime : " + myTime.getTime());
	}

	public void setName(String name) {
		this.name = name;
		System.out.println("2. 의존성 체크 후 property로  빈 인스턴스 주입 : name = " + name);
	}

	public void setMyMessage(MyMessage myMessage) {
		this.myMessage = myMessage;
		System.out.println("2. 의존성 체크 후 property로  빈 인스턴스 주입 : myMessage = " + myMessage.getMessage());
	}
	...
	public void sayHello() {
		...
		System.out.println(getMyTime().getTime());
	}
